...
void ShadowShader::InitShader(WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	samplerDesc.AddressW = D3D11_TEXTURE_ADDRESS_WRAP;//THESE WERE ALL _MIRROR 
...
void ShadowShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX &worldMatrix, const XMMATRIX &viewMatrix, 
	const XMMATRIX &projectionMatrix,const XMMATRIX &lightView,const XMMATRIX &lightProjection, ID3D11ShaderResourceView* texture, ID3D11ShaderResourceView*depthMap, Light* light,
	const XMMATRIX &lightView2, const XMMATRIX &lightProjection2, ID3D11ShaderResourceView*depthMap2, Light* light2)
{
	HRESULT result;
	...
	//////////////////////////
	lightPtr2->position2 = light2->GetPosition();
